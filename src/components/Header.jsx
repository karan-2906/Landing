...
const Header = () => {
  return (
    <div className="h-[97%] bg-hero-pattern bg-no-repeat bg-center bg-cover text-white ">
      ...
      <Navbar />
      <div className='h-full pb-36 flex flex-col justify-center items-start px-28'>
        <h1 className=' text-[5.5rem] font-semibold font-poppins'> <p>Full Fresh </p><p>100% Homemade </p>Juices</h1>
